...
import product17 from "./assets/17.png";
import product18 from "./assets/18.png";
import product19 from "./assets/19.png";
import product20 from "./assets/20.jpg";
import product21 from "./assets/21.png";
...
export const PRODUCTS = [
  {
    ...
    description:
      "Trafalgar Law ist der Kapitän der Heart Pirates und einer der Eleven Supernovas. Er hat die OP-Op-Teufelsfrucht gegessen und kann alles innerhalb seines Wirkungsbereichs verändern. Er ist ein Rivale und zeitweiliger Verbündeter von Luffy, auf den ein Kopfgeld von 500.000.000 Beeren ausgesetzt ist.",
  },
  {
    id: 2,
    productName: "Big Mom",
    ...
    description:
      "Big Mom ist die Kapitänin der Big Mom Pirates, eine der Four Yonko und das einzige weibliche Mitglied. Ihr richtiger Name ist Charlotte Linlin. Sie war die letzte Yonko, die erwähnt und gesehen wurde. Sie wohnt auf einer Insel in der Neuen Welt namens Whole Cake Island. Sie liebt alles, was süß ist, und hat eine große Vorliebe dafür.",
  },
  {
    id: 3,
    productName: "Fujitora",
    price: 4300,
    productImage: product3,
    description:
      "Fujitora ist der blinde Admiral der Marine. Er besitzt eine auf Schwerkraft basierende Teufelsfrucht und steht für blinde Gerechtigkeit. Sein richtiger Name ist Issho.",
  },
  {
    id: 4,
    productName: "Akoiji",
    ...
    description:
      "Kuzan, bekannt unter seinem früheren Decknamen Aokiji (Blauer Fasan), ist ein ehemaliger Admiral der Marines und ein ehemaliger Lehrling von Monkey D. Garp. Nach dem Paramount-Krieg wurde er für den Posten des Flottenadmirals nominiert, verlor ihn aber im Kampf gegen Akainu.",
  },
  {
    id: 5,
    productName: "Mihawk",
  ...
  },
  {
    ...
    description:
      "Nami, die Navigatorin der Strohhut-Piraten und ist von entscheidender Bedeutung. Sie ist klug, zeichnet Karten und träumt davon, eine Weltkarte zu erstellen. Nami ist auch die Schatzmeisterin der Crew und beherrscht den Umgang mit Geld. Ihre Intelligenz und Entschlossenheit machen sie zu einem wichtigen Crew-Mitglied.",
  },
  {
    id: 16,
    productName: "Lucci",
  ...
  },
  {
    ...
    description:
      "Marco, auch als (Phoenix) bekannt, war Kommandant der Whitebeard Pirates und besitzt die Teufelsfrucht (Tori Tori no Mi, Modell: Phoenix), die ihm erstaunliche Heilungskräfte verleiht. Er ist bekannt für seine Loyalität und seine Kampffähigkeiten, die ihn zu einer mächtigen und faszinierenden Figur machen.",
  },
];
